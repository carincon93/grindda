...
@section('content')
    <div class="container">
        @component('partials.info_formulario', ['rutaAtras' => route('semilleros.index') ])
            @slot('tipoFormulario')
                Formulario para editar un semillero.
            @endslot
            @slot('informacionFormulario')
                Modifique la información del semillero.
            @endslot
        @endcomponent
        <form class="" action="{{ route('semilleros.update', $semillero->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            {{ method_field('PUT') }}
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="nombre" type="text" class="form-control{{ $errors->has('nombre') ? ' is-invalid' : '' }}" name="nombre" value="{{ $semillero->nombre }}" required autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <select id="tipoSemillero" class="form-control{{ $errors->has('tipoSemillero') ? ' is-invalid' : '' }}" name="tipoSemillero" required>
                        ...
                        <option value="semillero tematico" {{ $semillero->tipoSemillero == 'semillero tematico' ? 'selected' : '' }}>Semillero temático</option>
                        <option value="semillero formacion" {{ $semillero->tipoSemillero == 'semillero formacion' ? 'selected' : '' }}>Semillero de formación</option>
                    </select>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="fechaCreacion" type="date" class="form-control{{ $errors->has('fechaCreacion') ? ' is-invalid' : '' }}" name="fechaCreacion" value="{{ $semillero->fechaCreacion }}" required>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="imagen" type="file" class="form-control{{ $errors->has('imagen') ? ' is-invalid' : '' }}" name="imagen" value="{{ $semillero->imagen }}" accept="image/*">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <textarea id="descripcion" class="form-control{{ $errors->has('descripcion') ? ' is-invalid' : '' }}" name="descripcion" rows="8" cols="80" required>{{ $semillero->descripcion }}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <textarea id="mision" class="form-control{{ $errors->has('mision') ? ' is-invalid' : '' }}" name="mision" rows="8" cols="80" required>{{ $semillero->mision }}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <textarea id="vision" class="form-control{{ $errors->has('vision') ? ' is-invalid' : '' }}" name="vision" rows="8" cols="80" required>{{ $semillero->vision }}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <textarea id="justificacion" class="form-control{{ $errors->has('justificacion') ? ' is-invalid' : '' }}" name="justificacion" rows="8" cols="80" required>{{ $semillero->justificacion }}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <textarea id="objetivoGeneral" class="form-control{{ $errors->has('objetivoGeneral') ? ' is-invalid' : '' }}" name="objetivoGeneral" rows="8" cols="80" required>{{ $semillero->objetivoGeneral }}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <textarea id="objetivosEspecificos" class="form-control{{ $errors->has('objetivosEspecificos') ? ' is-invalid' : '' }}" name="objetivosEspecificos" rows="8" cols="80" required>{{ $semillero->objetivosEspecificos }}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <textarea id="logros" class="form-control{{ $errors->has('logros') ? ' is-invalid' : '' }}" name="logros" rows="8" cols="80" required>{{ $semillero->logros }}</textarea>
